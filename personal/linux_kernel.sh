...
# Path defines
export SOURCE=/home/SagerChowdary/mainline/linux
export OUTPUT=/home/SagerChowdary/mainline
export ARCHIVES=/home/SagerChowdary/ROMs
...
# Name of zip
export NAME=Blush-${VER}_${PATCHLVL}_${SUBVER}-$COMMIT-$BUILDDATE-$BUILDTIME
